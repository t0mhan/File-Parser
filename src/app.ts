...
// return single rows
var rl: readline.Interface = readline.createInterface(instream);
...
rl.on('line', (line: string) => {
    ...
    if (singleLine.length == 4) {
        ...
        //if(lineCount < 5) console.log(splittedData);
    ...
    //if(lineCount < 5) console.log(operation[1]);
